...
// Type effectiveness table — rows = attacker, columns = defender
// Order follows TIPOS array above
export const EFF_TABLE = [
  ...
  [1,1,1,2,1,1,1,0.5,0.5,1,1,1,0.5,0.5,1,1,0.5,2], // poison
  ...
  [1,0.5,0.5,0.5,0.5,2,1,1,1,0.5,0.5,0.5,2,1,0.5,1,0.5,2], // steel
...
// ─── POKÉDEX ─────────────────────────────────────────────────────────────────
// Champions Regulation M-A legal Pokémon
...
export const POKEDEX = [
  ...
  { name: 'Floette-Eternal',      types: ['fairy'] },          // ⭐ Top meta — transfer from Legends Z-A via HOME
  ...
  { name: 'Incineroar',           types: ['fire', 'dark'] },   // ⭐ #1 usage in Champions Reg M-A
