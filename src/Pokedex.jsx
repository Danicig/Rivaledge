...
const ALL_POKEMON = [
  ...
  { name:'Meowstic-F',         id:678,   apiName:'meowstic-f',            gen:6, types:['psychic'],           canMega:true  },
  ...
  { name:'Heliolisk',          id:695,   apiName:'heliolisk',             gen:6, types:['electric','normal'], canMega:false },
  { name:'Tyrantrum',          id:697,   apiName:'tyrantrum',             gen:6, types:['rock','dragon'],     canMega:false },
  { name:'Aurorus',            id:699,   apiName:'aurorus',               gen:6, types:['rock','ice'],        canMega:false },
  { name:'Sylveon',            id:700,   apiName:'sylveon',               gen:6, types:['fairy'],             canMega:false },
  { name:'Hawlucha',           id:701,   apiName:'hawlucha',              gen:6, types:['fighting','flying'], canMega:false },
  { name:'Dedenne',            id:702,   apiName:'dedenne',               gen:6, types:['electric','fairy'],  canMega:false },
  { name:'Goodra',             id:706,   apiName:'goodra',                gen:6, types:['dragon'],            canMega:false },
  { name:'Hisuian Goodra',     id:10243, apiName:'goodra-hisui',          gen:6, types:['dragon','steel'],    canMega:false },
  { name:'Klefki',             id:707,   apiName:'klefki',                gen:6, types:['steel','fairy'],     canMega:false },
  { name:'Trevenant',          id:709,   apiName:'trevenant',             gen:6, types:['ghost','grass'],     canMega:false },
  { name:'Gourgeist',          id:711,   apiName:'gourgeist',             gen:6, types:['ghost','grass'],     canMega:false },
  { name:'Avalugg',            id:713,   apiName:'avalugg',               gen:6, types:['ice'],               canMega:false },
  { name:'Hisuian Avalugg',    id:10244, apiName:'avalugg-hisui',         gen:6, types:['ice','rock'],        canMega:false },
  ...
  { name:'Hisuian Decidueye',  id:10232, apiName:'decidueye-hisui',       gen:7, types:['grass','fighting'],  canMega:false },
  ...
  { name:'Toucannon',          id:733,   apiName:'toucannon',             gen:7, types:['normal','flying'],   canMega:false },
  { name:'Crabominable',       id:740,   apiName:'crabominable',          gen:7, types:['fighting','ice'],    canMega:false },
  { name:'Lycanroc-Midday',    id:745,   apiName:'lycanroc',              gen:7, types:['rock'],              canMega:false },
  { name:'Lycanroc-Midnight',  id:10116, apiName:'lycanroc-midnight',     gen:7, types:['rock'],              canMega:false },
  { name:'Lycanroc-Dusk',      id:10117, apiName:'lycanroc-dusk',         gen:7, types:['rock'],              canMega:false },
  ...
  { name:'Oranguru',           id:765,   apiName:'oranguru',              gen:7, types:['normal','psychic'],  canMega:false },
  { name:'Passimian',          id:766,   apiName:'passimian',             gen:7, types:['fighting'],          canMega:false },
  { name:'Mimikyu',            id:778,   apiName:'mimikyu',               gen:7, types:['ghost','fairy'],     canMega:false },
  { name:'Drampa',             id:780,   apiName:'drampa',                gen:7, types:['normal','dragon'],   canMega:false },
  ...
  { name:'Flapple',            id:841,   apiName:'flapple',               gen:8, types:['grass','dragon'],    canMega:false },
  { name:'Appletun',           id:842,   apiName:'appletun',              gen:8, types:['grass','dragon'],    canMega:false },
  ...
  { name:'Mr. Rime',           id:866,   apiName:'mr-rime',               gen:8, types:['ice','psychic'],     canMega:false },
  { name:'Runerigus',          id:867,   apiName:'runerigus',             gen:8, types:['ground','ghost'],    canMega:false },
  { name:'Alcremie',           id:869,   apiName:'alcremie',              gen:8, types:['fairy'],             canMega:false },
  { name:'Morpeko',            id:877,   apiName:'morpeko',               gen:8, types:['electric','dark'],   canMega:false },
  { name:'Dragapult',          id:887,   apiName:'dragapult',             gen:8, types:['dragon','ghost'],    canMega:false },
  { name:'Wyrdeer',            id:899,   apiName:'wyrdeer',               gen:8, types:['normal','psychic'],  canMega:false },
  { name:'Kleavor',            id:900,   apiName:'kleavor',               gen:8, types:['bug','rock'],        canMega:false },
  { name:'Basculegion',        id:902,   apiName:'basculegion',           gen:8, types:['water','ghost'],     canMega:false },
  { name:'Basculegion-F',      id:10236, apiName:'basculegion-f',         gen:8, types:['water','ghost'],     canMega:false },
  ...
  { name:'Palafin',            id:964,   apiName:'palafin',               gen:9, types:['water'],             canMega:false },
  { name:'Orthworm',           id:968,   apiName:'orthworm',              gen:9, types:['steel'],             canMega:false },
  ...
  { name:'Sinistcha',          id:1013,  apiName:'sinistcha',             gen:9, types:['grass','ghost'],     canMega:false },
  { name:'Archaludon',         id:1018,  apiName:'archaludon',            gen:9, types:['dragon','steel'],    canMega:false },
  { name:'Hydrapple',          id:1019,  apiName:'hydrapple',             gen:9, types:['grass','dragon'],    canMega:false },
]
